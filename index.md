...
<p>
Everyone who participates in UKRN activities is required to conform to the <a href="{{ site.code_of_conduct }}">UKRN Code of Conduct</a>. This document also outlines how to report an incident if needed.
</p>
